...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，昨天是段历史, Hi，明天是个谜团,Hi，今天是天赐的礼物🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Deng You', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个平凡的普通人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://music.dengyou.online', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Deng You', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/521xueweihan/HelloGitHub', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1375298909?spm_id_from=333.1007.0.0', // B站主页
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '61550327402354', // Facebook Page ID 來啟用 messenger 聊天功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'DengYou', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
